...
# Optional imports for linting functionality
try:
...
if LINTING_AVAILABLE:
    ...
    # Placeholder implementations when linting dependencies are not available
    def tree_context(fname, code, line_nums):
        raise ImportError(
            f"Linting dependencies not available: {_missing_import}. "
            "Install with: pip install openhands-aci[linting]"
        )
