...
if markdownify is not None:
    ...
    # Placeholder class when markdownify is not available
    class _CustomMarkdownify:
        def __init__(self, **options: Any):
            raise ImportError("markdownify is not available. Install with: pip install openhands-aci[documents]")
...
class MarkdownConverter:
    ...
    def __init__(
        ...
        if not DOCUMENT_PROCESSING_AVAILABLE:
            raise ImportError(
                f"Document processing dependencies not available: {_missing_import}. "
                "Install with: pip install openhands-aci[documents]"
            )
