...
def editor_cp1251_file(tmp_path):
    """Create a test file with cp1251 encoding from the fixture."""
    ...
    fixture_path = get_fixture_path('cp1251_sample.py')

    # Read the content as UTF-8 (since we're in development)
